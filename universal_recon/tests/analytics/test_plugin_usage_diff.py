...
class TestPluginUsageDiff(TestCase):
    ...
    def test_load_plugins_with_valid_json(self):
        ...
        test_data = {"plugins_used": ["plugin1", "plugin2", "plugin3"]}
...
def test_load_plugins():
    plugins = load_plugins("tests/fixtures/sample_schema.json")
    assert isinstance(plugins, set)


def test_load_plugins_missing_file():
    plugins = load_plugins("nonexistent_file.json")
