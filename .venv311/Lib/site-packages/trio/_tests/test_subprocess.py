...
from .. import Event, Process, _core, fail_after, move_on_after, run_process, sleep, sleep_forever
...
def test_waitid_eintr() -> None:
    ...
    from .._subprocess_platform.waitid import sync_wait_reapable  # type: ignore[attr-defined, unused-ignore]
