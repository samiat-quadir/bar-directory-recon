...
from typing import TYPE_CHECKING, Any, SupportsIndex, TypeVar, Union, overload
...
def _sniff_sockopts_for_fileno(
    ...
    from socket import SO_DOMAIN, SO_PROTOCOL, SO_TYPE, SOL_SOCKET  # type: ignore[attr-defined,unused-ignore]
