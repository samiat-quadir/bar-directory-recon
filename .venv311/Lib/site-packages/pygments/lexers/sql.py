...
from pygments.lexers import ClassNotFound, _googlesql_builtins, _tsql_builtins, get_lexer_by_name
...
from pygments.lexers._postgres_builtins import DATATYPES, EXPLAIN_KEYWORDS, KEYWORDS, PLPGSQL_KEYWORDS, PSEUDO_TYPES
