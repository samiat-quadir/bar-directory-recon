...
from typing import TYPE_CHECKING, Any, Dict, Iterable, List, Optional, Pattern, Set, Tuple, Type, cast
...
if TYPE_CHECKING:
    ...
    from bs4._typing import _AttributeValue, _Encoding, _Encodings, _RawMarkup, _RawOrProcessedAttributeValues
