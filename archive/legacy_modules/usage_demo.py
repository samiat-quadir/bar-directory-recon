...
print("   Command: python universal_automation.py --industry pool_contractors --city Miami --state FL --export google_sheets")
print("")
...
print("   📁 Found credentials file: client_secret_1020100796152-n6l4bloev9ha8to4mcbc6h3p8e1n1t3e.apps.googleusercontent.com.json")
...
print("      🔄 Updated: 0")
print("      ⏭️ Skipped: 0")
print("   ✅ Google Sheets export successful: https://docs.google.com/spreadsheets/d/1ABC...xyz/edit#gid=0")
