...
def enrich_property_data(properties):
    ...
    for prop in properties:
        ...
        is_corporate = any(
            indicator in prop["owner_name"].upper()
...
def main():
    ...
    with open(summary_file, "w") as f:
        ...
        f.write(
            f"  Overall Contact Enrichment: {((records_with_email + records_with_phone)/(total_records*2))*100:.1f}%\\n"
        )
    ...
    print("\n🚀 Next steps:")
    print("  1. Review priority properties in Excel file")
    print("  2. Manually verify high-value corporate entities")
    print("  3. Follow up on missing contact information")
    print("  4. Optional: Upload to Google Sheets with --export flag")
