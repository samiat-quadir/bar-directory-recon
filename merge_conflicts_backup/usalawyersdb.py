...
<<<<<<< HEAD
    ...
    encoding="utf-8",
=======
    filename=log_file_path, level=logging.INFO, format="%(asctime)s | %(levelname)s | %(message)s", encoding="utf-8"
...
"""TODO: Add docstring."""
    try:
        profile_data = {
            ...
            "City": get_element_text("/html/body/div[2]/div[2]/div/div[5]/div/div[1]/p[2]/a[1]/span"),
            ...
            "Website": get_element_attribute("/html/body/div[2]/div[2]/div/div[5]/div/div[1]/p[4]/a", "href"),
        }
...
"""TODO: Add docstring."""
    ...
    while lawyers_scraped < total_lawyers:
        try:
            profile_links = driver.find_elements(By.XPATH, "/html/body/div[2]/div[1]/div/div/div[5]/ul[1]/li/a[1]")
            ...
            if lawyers_scraped < total_lawyers:
                next_page_xpath = f"/html/body/div[2]/div[1]/div/div/div[5]/ul[2]/li[{current_page + 1}]/a"
...
"""TODO: Add docstring."""
    ...
    try:
        if os.path.exists(file_path):
            ...
            pd.DataFrame(data, columns=columns).to_excel(file_path, sheet_name=sheet_name, index=False)
...
=======
                {"name": element.text.strip(), "xpath": f"/html/body/div[2]/div[2]/div/div[15]/ul/li[{idx}]/a"}
>>>>>>> 3ccf4fd (Committing all changes)
            )
...
=======
                {"name": element.text.strip(), "xpath": f"/html/body/div[2]/div[2]/div/div[16]/ul/li[{idx}]/a"}
>>>>>>> 3ccf4fd (Committing all changes)
            )
        ...
        logger.error("Error encountered during scraping")
