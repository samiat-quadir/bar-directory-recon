...
def analyze_coverage_and_roi():
    ...
    coverage_files = [
        ...
        {
            "file": "src/property_validation.py",
            "statements": 286,
            "missed": 247,
            "coverage": 14,
        },
        ...
        {
            "file": "src/property_enrichment.py",
            "statements": 211,
            "missed": 211,
            "coverage": 0,
        },
        {
            "file": "src/pagination_manager.py",
            "statements": 204,
            "missed": 187,
            "coverage": 8,
        },
        ...
        {
            "file": "src/webdriver_manager.py",
            "statements": 177,
            "missed": 165,
            "coverage": 7,
        },
        {
            "file": "src/notification_agent.py",
            "statements": 169,
            "missed": 169,
            "coverage": 0,
        },
        ...
        {
            "file": "src/security_audit.py",
            "statements": 165,
            "missed": 165,
            "coverage": 0,
        },
        {
            "file": "src/hallandale_pipeline.py",
            "statements": 162,
            "missed": 162,
            "coverage": 0,
        },
        {
            "file": "src/unified_schema.py",
            "statements": 153,
            "missed": 110,
            "coverage": 28,
        },
        {
            "file": "src/hallandale_pipeline_fixed.py",
            "statements": 140,
            "missed": 140,
            "coverage": 0,
        },
        {
            "file": "src/refactored_scraping_orchestrator.py",
            "statements": 95,
            "missed": 95,
            "coverage": 0,
        },
    ...
    for file_data in coverage_files:
        ...
        for cc_file, cc_data in complexity_data.items():
            if filename.endswith(pathlib.Path(cc_file).name) or cc_file.endswith(
    ...
    for i, cand in enumerate(top_candidates, 1):
        print(
            f"   {i:2d}. {pathlib.Path(cand['file']).name:<30} ROI:{cand['roi']:>6} Gap:{cand['gap']:>3} Comp:{cand['complexity']:>2}"
        )
